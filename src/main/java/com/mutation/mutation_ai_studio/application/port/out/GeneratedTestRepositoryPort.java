...
public interface GeneratedTestRepositoryPort {
    ...
    Path save(Path projectRoot, GeneratedTestCandidate candidate, Instant createdAt);

    Path saveFailed(Path projectRoot, GeneratedTestCandidate candidate, Instant createdAt);
}
